...
public class UserInterface {
     ...
     * Current user
     */
    private static PersonRole user;
        ...
        while(!logout) {
            ...
            switch (selection) {
                ...
                case 4:
                    ...
                    input2 = sc.next();
                    result = admin.access.branchEmployeeController.createNewBranchEmployee(input, input2);
                    break;
                case 5:
                ...
                case 7:
                    ...
                    input = sc.next();
                    result = admin.access.transportationPersonnelController.createNewTransportationPersonnel(input);
                    break;
                case 8:
        ...
        while(!logout) {
            ...
            switch (selection) {
                ...
                case 5:
                    ...
                    input = sc.next();
                    result = employee.access.customerController.createNewCustomer(input);
                    break;
                case 6:
